...
public interface RuleEngineAlarmService {
    ...
    AlarmSeverityEnum findHighestAlarmSeverity(TenantId tenantId, EntityId entityId, AlarmSearchStatusEnum alarmSearchStatusEnum, AlarmStatusEnum alarmStatusEnum, String assigneeId);
