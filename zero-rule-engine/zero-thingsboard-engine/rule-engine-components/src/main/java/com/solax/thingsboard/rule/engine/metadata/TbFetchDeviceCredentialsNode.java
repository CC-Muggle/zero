...
import org.thingsboard.server.common.data.security.DeviceCredentialsTypeEnum;
...
public class TbFetchDeviceCredentialsNode implements TbNode {
    ...
    public void onMsg(TbContext ctx, TbMsg msg) throws ExecutionException, InterruptedException, TbNodeException {
        ...
        if (!EntityTypeEnum.DEVICE.equals(originator.getEntityType())) {
        ...
        DeviceCredentialsTypeEnum credentialsType = deviceCredentials.getCredentialsType();
        ...
        if (fetchToMetadata) {
            ...
            if (credentialsType.equals(DeviceCredentialsTypeEnum.ACCESS_TOKEN) || credentialsType.equals(DeviceCredentialsTypeEnum.X509_CERTIFICATE)) {
