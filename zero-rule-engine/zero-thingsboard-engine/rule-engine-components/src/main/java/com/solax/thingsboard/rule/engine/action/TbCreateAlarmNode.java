...
import org.thingsboard.server.common.data.alarm.AlarmSeverityEnum;
...
public class TbCreateAlarmNode extends TbAbstractAlarmNode<TbCreateAlarmNodeConfiguration> {
    ...
    private AlarmSeverityEnum notDynamicAlarmSeverityEnum;

    @Override
    public void init(TbContext ctx, TbNodeConfiguration configuration) throws TbNodeException {
        super.init(ctx, configuration);
        if (!this.config.isDynamicSeverity()) {
            this.notDynamicAlarmSeverityEnum = EnumUtils.getEnum(AlarmSeverityEnum.class, this.config.getSeverity());
            if (this.notDynamicAlarmSeverityEnum == null) {
    ...
    private Alarm buildAlarm(TbMsg msg, JsonNode details, TenantId tenantId) {
        ...
        return Alarm.builder()
                ...
                .cleared(false)
                .acknowledged(false)
                .severity(this.config.isDynamicSeverity() ? processAlarmSeverity(msg) : notDynamicAlarmSeverityEnum)
    ...
    private AlarmSeverityEnum processAlarmSeverity(TbMsg msg) {
        AlarmSeverityEnum severity = EnumUtils.getEnum(AlarmSeverityEnum.class, TbNodeUtils.processPattern(this.config.getSeverity(), msg));
        if (severity == null) {
